...
if TYPE_CHECKING:
    ...
    def assertRaisesMessage(
        expected_exception: BaseException, expected_message: str, *args, **kwargs
    ):
        ...

    def assertWarnsMessage(
        expected_warning: Warning, expected_message: str, *args, **kwargs
    ):
        ...
    ...
    def assertNumQueries(num: int, func=..., *args, using: str = ..., **kwargs):
        ...
